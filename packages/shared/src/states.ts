 ...
 *   frozen   — paused, memory reclaimed to swap (~50ms to wake)
 *   stopped  — container removed, disk image kept (seconds to wake)
 *   archived — compressed to S3, local disk freed (minutes to wake)
 *
