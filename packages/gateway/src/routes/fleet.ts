 ...
 * reading; getFleetStateHistory is the past, from the samples the
 * check-ins wrote (db/fleet-samples.ts). Behind the sandbox gate, as
...
export const fleetRoutes: FastifyPluginAsyncZod<FleetRoutesOptions> = async (
  ...
  // The fleet's past: state counts per check-in, sliced and (past 360
