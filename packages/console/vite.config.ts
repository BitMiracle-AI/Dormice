...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/updatePolicy': 'http://127.0.0.1:3676',
      '/updateMetadata': 'http://127.0.0.1:3676',
      '/listTemplates': 'http://127.0.0.1:3676',
      '/registerTemplate': 'http://127.0.0.1:3676',
      '/removeTemplate': 'http://127.0.0.1:3676',
      '/listApiKeys': 'http://127.0.0.1:3676',
      '/createApiKey': 'http://127.0.0.1:3676',
      '/revokeApiKey': 'http://127.0.0.1:3676',
      '/updateApiKey': 'http://127.0.0.1:3676',
      '/execCommand': 'http://127.0.0.1:3676',
      '/writeFile': 'http://127.0.0.1:3676',
      '/writeFiles': 'http://127.0.0.1:3676',
      '/readFile': 'http://127.0.0.1:3676',
      '/readFiles': 'http://127.0.0.1:3676',
      '/getHostMetrics': 'http://127.0.0.1:3676',
      '/getSandboxMetrics': 'http://127.0.0.1:3676',
      '/getSandboxMetricsHistory': 'http://127.0.0.1:3676',
