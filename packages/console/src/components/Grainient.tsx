...
const hexToRgb = (hex: string): [number, number, number] => {
  // Fix-up for this repo's noUncheckedIndexedAccess (registry code assumes
  // plain indexing) — see RULES/前端.md shadcn known pits.
...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    if (!ctx) return;
    const { program } = ctx;
    // Literal-key cast instead of a string index, same noUncheckedIndexedAccess fix-up.
